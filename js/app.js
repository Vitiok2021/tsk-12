(() => {
    ...
    function initSliders() {
        if (document.querySelector(".body-product__images")) {
            let thumbsSwiper = new swiper_core_Swiper(".images-preview__slider", {
                ...
                navigation: {
                    prevEl: ".images-preview__button--up",
                    nextEl: ".images-preview__button--down"
                },
                on: {}
            });
            new swiper_core_Swiper(".images-product__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".images-product__button--up",
                    nextEl: ".images-product__button--down"
                },
                on: {}
            });
        }
        if (document.querySelector(".klanten-product__slider")) new swiper_core_Swiper(".klanten-product__slider", {
    ...
    let body = document.querySelector("body");
    if (isMobile2.any()) body.classList.add("touch"); else body.classList.add("mouse");
